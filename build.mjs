...
await Promise.all([
  ...
  copyFile(resolve(root, 'redesign.css'), resolve(dist, 'client', 'redesign.css')),
  copyFile(resolve(root, 'image', 'initial-d-legend.jpg'), resolve(dist, 'client', 'image', 'initial-d-legend.jpg')),
  ...
  copyFile(resolve(root, 'image', 'logocinepafftext.svg'), resolve(dist, 'client', 'image', 'logocinepafftext.svg')),
  copyFile(resolve(root, 'image', 'logocinepafficon.svg'), resolve(dist, 'client', 'image', 'logocinepafficon.svg')),
  copyFile(resolve(root, 'worker', 'index.js'), resolve(dist, 'server', 'index.js')),
]);

console.log('CinePaff build ready.');
